...
public class MainActivity extends ListActivity {
    ...
    // JSON Node names
    private static final String TAG_STUDENTINFO = "studentsinfo";//this is the name at the start of the json data returned by url
    ...
    private class GetStudents extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            //This is the string of the response
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.list_item, new String[]{TAG_NAME, TAG_PHONE_MOBILE}, new int[]{R.id.name, R.id.mobile});
